...
#the visual representation of the residual allows to easily recognise the difference between the predicted values and the actual ones. The model lacks predictability.
```
```{r}
