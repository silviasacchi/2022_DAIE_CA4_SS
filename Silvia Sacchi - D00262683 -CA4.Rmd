...
#meets the y axes.
#β1 is the average change in y when x increases by 1 unit. In this case, it represents the average change in monthly expenditure when the average monthly time spent playing increases by 1 hour.
